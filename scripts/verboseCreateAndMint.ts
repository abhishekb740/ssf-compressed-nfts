...
(async () => {
  ...
  console.log("Test wallet address: CxjawXnJxAyb7Zx3xCkSD3nxamdpcfSikvnnC7C8RMHh");
  ...
  */
  ...
  const collectionMetadataV3: CreateMetadataAccountArgsV3 = {
    data: {
      ...
      uri: "https://amethyst-imaginative-panther-173.mypinata.cloud/ipfs/Qme8UAhKj4NmwHTfoyV2mkLNtXCy9XrP3b5gHAHMGTP9Qw",
